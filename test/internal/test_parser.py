...
def test_export_error_parser(mocker, ns):
    ...
    parser = ErrorParser()
    result = parser.export_error_parser({'expense_category': '1', 'employee': '12'}, ns, 'An error occured in a upsert request: Invalid category reference key 1 for entity 12')
